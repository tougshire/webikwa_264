...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                #('body', wagtail.fields.StreamField([('markdown_block', 0), ('paragraph_block', 1), ('heading_block', 4), ('document_block', 5), ('quote_block', 6), ('image_block', 11), ('eventlist_block', 12), ('external_image_block', 14), ('embed_block', 15), ('html_block', 16), ('table', 17)], blank=True, block_lookup={0: ('wagtailmarkdown.blocks.MarkdownBlock', (), {'icon': 'code'}), 1: ('wagtail.blocks.RichTextBlock', (), {'features': ['link', 'bold', 'italic', 'ol', 'ul'], 'icon': 'pilcrow'}), 2: ('wagtail.blocks.CharBlock', (), {'form_classname': 'title', 'required': True}), 3: ('wagtail.blocks.ChoiceBlock', [], {'blank': True, 'choices': [('', 'Select a heading size'), ('h2', 'H2'), ('h3', 'H3'), ('h4', 'H4'), ('h5', 'H5'), ('h6', 'H6')], 'required': False}), 4: ('wagtail.blocks.StructBlock', [[('heading_text', 2), ('size', 3)]], {}), 5: ('wagtail.documents.blocks.DocumentChooserBlock', (), {}), 6: ('wagtail.blocks.BlockQuoteBlock', (), {}), 7: ('wagtail.images.blocks.ImageChooserBlock', (), {'required': True}), 8: ('wagtail.blocks.CharBlock', (), {'required': False}), 9: ('wagtail.blocks.CharBlock', (), {'required': True}), 10: ('wagtail.blocks.URLBlock', (), {'required': False}), 11: ('wagtail.blocks.StructBlock', [[('image', 7), ('caption', 8), ('attribution', 8), ('alt', 9), ('link', 10)]], {}), 12: ('webikwa_264.blocks.EventlistBlock', (), {'child_block': wagtail.blocks.StructBlock([('date', wagtail.blocks.DateBlock()), ('time', wagtail.blocks.TimeBlock(help_text='The starting time of the event (uses 24 hour clock.  See https://simple.wikipedia.org/wiki/24-hour_clock', required=False)), ('article', wagtail.blocks.PageChooserBlock(help_text="Optionaly, an article to link to. If URL is filled in, the aricle's URL will be ignored. If description is filled in, the article's title will be ignored", page_type=['webikwa_264.ArticlePage'], required=False)), ('description', wagtail.blocks.CharBlock(help_text="A description of the event.  If an article is chosen, this can be left blank to use the article's title", required=False)), ('url', wagtail.blocks.URLBlock(help_text="A URL for the event.  If an article is chosen, this can be left blank to use the article's URL.  If there is no article and this is blank, the description will not be a link", required=False)), ('show_days_before_start', wagtail.blocks.IntegerBlock(default=90)), ('show_days_after_end', wagtail.blocks.IntegerBlock(default=1))])}), 13: ('wagtail.blocks.URLBlock', (), {'required': True}), 14: ('wagtail.blocks.StructBlock', [[('url', 13), ('caption', 8), ('attribution', 8), ('alt', 9), ('link', 10)]], {}), 15: ('wagtail.embeds.blocks.EmbedBlock', (), {'help_text': 'The URL of the source', 'icon': 'media'}), 16: ('wagtail.blocks.RawHTMLBlock', (), {}), 17: ('wagtail.contrib.table_block.blocks.TableBlock', (), {})}, help_text='The body of the article')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date.today, verbose_name='Post date')),
                ('summary', models.TextField(blank=True, help_text='A summary to be displayed instead of the body for index views')),
            ],
            options={
